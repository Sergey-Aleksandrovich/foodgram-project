...
const authorRecipe = new Profile(container, '.card', header, api, true, {
    purchases,
    favorites
});

const authorRecipeSubscribe = new Profile(container_subscribe, '.author-subscribe', header, api, true, {
    subscribe
});
